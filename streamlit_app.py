...
def load_data():
    ...
    Settings.llm = Gemini(
        ...
        temperature=0.2,
        system_prompt="""You are an expert on the work of A Dollhouse.
        Answer the question using the provided documents, which contain relevant excerpts from the work of A Dollhouse.
        The context for all questions is the work of A Dollhouse. Whenver possible, include a quotation from the provided excerpts of his work to illustrate your point.
